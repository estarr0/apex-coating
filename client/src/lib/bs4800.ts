...
export const BS4800_COLORS: BSColor[] = [
  ...
  c("#d89858", "12 C 41", "Amber", "Oranges & Yellows"),
  ...
  c("#e8d070", "08 C 31", "Sunflower", "Oranges & Yellows"),
  c("#d8b848", "10 C 33", "Mustard", "Oranges & Yellows"),
  c("#c89828", "10 C 35", "Goldenrod", "Oranges & Yellows"),
  c("#a87818", "10 C 37", "Bronze Gold", "Oranges & Yellows"),
